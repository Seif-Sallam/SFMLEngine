...
{
	m_FontLoader = new ResourceLoader<sf::Font>(RSC_DIR "failed/arial.ttf");
	m_TextureLoader = new ResourceLoader<sf::Texture>(RSC_DIR "failed/failed.png");
	m_SoundBufferLoader = new ResourceLoader<sf::SoundBuffer>(RSC_DIR "failed/Silent.wav");
}